...
def number_template(n):
    """property that displays a HTML page
    only if n is a integer"""
    le_number = f"number: {n}"
    return render_template('5-number.html', my_object=le_number)
...
def number_odd_or_even(n):
    ...
    if n % 2 == 0:
        ...
        return render_template('6-number_odd_or_even.html',
                               le_object=f"Number: {n} is even")
    else:
        return render_template('6-number_odd_or_even.html',
                               le_object=f"Number: {n} is odd")
